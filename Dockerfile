...
# Build extension (postinstall would also run automatically, but we run explicitly)
...
# Copy Chromium from builder (if downloaded)
# Puppeteer downloads Chromium to ~/.cache/puppeteer
